...
// checks if the ChannelTarget type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChannelTarget{}
...
func (v NullableChannelTarget) Get() *ChannelTarget {
	return v.value
}
...
func NewNullableChannelTarget(val *ChannelTarget) *NullableChannelTarget {
	return &NullableChannelTarget{value: val, isSet: true}
}
