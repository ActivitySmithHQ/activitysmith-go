...
// checks if the ActivityMetric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivityMetric{}
...
func (v NullableActivityMetric) Get() *ActivityMetric {
	return v.value
}

func (v *NullableActivityMetric) Set(val *ActivityMetric) {
	v.value = val
	v.isSet = true
}
...
func NewNullableActivityMetric(val *ActivityMetric) *NullableActivityMetric {
	return &NullableActivityMetric{value: val, isSet: true}
}
